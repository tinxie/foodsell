  	...
  	<transition name="slide">
       <div class="food" v-show="showFlag" ref="foodsWrapper">
       	  <div class="food-content">
       	  	...
       	  	<div class="content">
      			...
      			<div class="cartcontrol-wrapper">
       	  	    ...
       	  	    <div class="buy" v-show="!food.count || food.count === 0" @click="addCart">加入购物车</div>
       	  	 </div>
       	  ...
       	  <div class="rating">
       	  	...
       	  	<ratingselect :selectType="selectType"  :onlyContent=" onlyContent" :desc="desc" :ratings="food.ratings" @ratingtypeselect="ratingtypeselect" @contenToggle="contentToggle"></ratingselect>
